...
import boot.lab08.Aluno;
import boot.lab08.AlunoRestController;
...
public class AlunoRestControllerTest {
	...
	public void testCreate() throws Exception {
		Aluno aluno = new Aluno(6l, "Leonardo", 66666, "leonardo@email.com", new Date());
		mockMvc.perform(post("/alunos").contentType(MediaType.APPLICATION_JSON_UTF8)
				...
				.andExpect(jsonPath("$.nome", equalTo("Leonardo")));
	}
